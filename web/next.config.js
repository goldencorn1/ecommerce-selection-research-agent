...
const config = {
  ...
  webpack: (config) => {
    ...
    // Node 24 on Windows can report EISDIR while Webpack snapshots file
    // symlinks/readlink targets. Disable only the local filesystem cache so
    // production builds remain deterministic; Docker/Linux keeps the cache.
