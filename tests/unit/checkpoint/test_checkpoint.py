...
def test_postgresql_insert_update_and_error_paths(monkeypatch):
    """Exercise PostgreSQL update, insert, and error/rollback branches."""
    # The test replaces the connection with a fake below; avoid opening a real
    # localhost socket while the manager constructor initializes PostgreSQL.
    monkeypatch.setattr(
...
def test_create_chat_streams_table_success_and_error(monkeypatch):
